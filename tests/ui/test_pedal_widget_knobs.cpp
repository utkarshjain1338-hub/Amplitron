...
TEST_F(PresetTest, test_pedal_widget_knobs_rendering_and_layouts) {
    ...
    w_od.render_knobs(dl, ImVec2(10, 10), 190.0f, false, false, false, 1.0f);
    advance_frame();
    ...
    w_amp.render_knobs(dl, ImVec2(10, 10), 190.0f, true, false, false, 1.0f);
    advance_frame();
    ...
    w_cab.render_knobs(dl, ImVec2(10, 10), 190.0f, false, false, true, 1.0f);
    advance_frame();
    ...
    w_tuner.render_knobs(dl, ImVec2(10, 10), 190.0f, false, true, false, 1.0f);
    advance_frame();
...
TEST_F(PresetTest, test_pedal_widget_knobs_callbacks_and_midi) {
    ...
    gui_midi.manager().learn_effect_name_ = od->name();
    gui_midi.manager().learn_param_name_ = od->params()[0].name;
