...
PaDeviceIndex MOCK_Pa_HostApiDeviceIndexToDeviceIndex(PaHostApiIndex hostApi,
    ...
    if (Amplitron::g_mock_pa_host_api_device_index_to_device_index)
        return Amplitron::g_mock_pa_host_api_device_index_to_device_index(hostApi,
                                                                          hostApiDeviceIndex);
...
PaError MOCK_Pa_OpenStream(PaStream **stream, const PaStreamParameters *inputParameters,
    ...
    if (Amplitron::g_mock_pa_open_stream)
        return Amplitron::g_mock_pa_open_stream(stream, inputParameters, outputParameters,
