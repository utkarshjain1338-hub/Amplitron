...
MultiBandCompressor::MultiBandCompressor() {
    params_ = {// Crossovers
               ...
               {"Low Makeup", 0.0f, 0.0f, 30.0f, 0.0f, "dB",
                "Low band makeup gain: volume boost applied to the compressed Low band."},
               ...
               {"Mid Makeup", 0.0f, 0.0f, 30.0f, 0.0f, "dB",
                "Mid band makeup gain: volume boost applied to the compressed Mid band."},
               ...
               {"High Makeup", 0.0f, 0.0f, 30.0f, 0.0f, "dB",
                "High band makeup gain: volume boost applied to the compressed High band."},
...
void MultiBandCompressor::process(float* buffer, int num_samples) {
    ...
    float makeup[3] = {db_to_linear(params_[6].value), db_to_linear(params_[11].value),
    ...
    const float alpha =
        1.0f - std::exp(-1.0f / (sample_rate_ * 0.002f));  // 2 ms smoothing time constant
    for (int b = 0; b < 3; ++b) {
