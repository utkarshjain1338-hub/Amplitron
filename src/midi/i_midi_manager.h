...
public:
    ...
    virtual void remove_mapping_for_param(const std::string& effect_name, const std::string& param_name) = 0;
...
public:
    ...
    virtual void start_learn(MidiTargetType type, const std::string& effect_name, const std::string& param_name) = 0;
 ...
 */
class IMidiManager : public IMidiPortManager, public IMidiMappingService, public IMidiLearnSession, public IMidiConfigStore {
public:
